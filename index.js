...
app.get('/admin/:email', async(req, res) => {
  ...
  res.send({admin: isAdmin})
     ...
     * app.get('/booking') // get all bookings in this colloection. or get more then one or by filter
     * app.get('booking/:id') // get a specific booking
     * app.post('booking') // add a new booking
     * app.patch('/booking/:id') // 
     * app.put('/booking/:id') // upsert ==> update (if exists) or insert (if does't exist)
